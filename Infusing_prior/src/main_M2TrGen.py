...
def parse_agrs():
    ...
    parser.add_argument('--labeled_report_path', type=str, default='data/iu_xray/labeld_reports.csv', help='the path to the directory containing the data.')
...
def main():
    ...
    #            ckpt_path="/cluster/work/medinfmk/ARGON2/ARGON-main/results/mimic_cxr/m2tr/model_best.ckpt")
