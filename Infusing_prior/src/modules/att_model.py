...
class AttModel(CaptionModel):
    def __init__(self, args, tokenizer):
        ...
        if args.infuse_prior:
            args.d_vf = 1025 # 1024 patch features + label
        else:
            args.d_vf = 1024 
    ...
    def get_logprobs_state(self, it, fc_feats, att_feats, p_att_feats, att_masks, state, output_logsoftmax=1):
        ...
        #print("-"*108)
        #print("In att_model.py, Beam get_logprobs_state()")
        #print("xt", xt.shape)
    ...
    def _sample(self, fc_feats, att_feats, att_masks=None, comparison=None):
