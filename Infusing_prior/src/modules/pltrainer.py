...
class pltrain():
    ...
    def __init__(self, model, args, data_module):
        ...
        self.trainer = pl.Trainer(
            ...
            max_epochs=args.epochs, deterministic=False,
            devices=args.n_gpu,
            accelerator="gpu",
    ...
    def evaluate(self, model, datamodule, ckpt_path=None):
        self.trainer.test(model=model, datamodule=datamodule, ckpt_path=ckpt_path)
