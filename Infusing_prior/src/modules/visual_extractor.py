...
class VisualExtractor(nn.Module):
    def __init__(self, args):
        ...
        self.cached_file = "/cluster/work/medinfmk/ARGON/containers/models/resnet101-5d3b4d8f.pth"
        ...
        if self.pretrained:
            ...
            model = getattr(models, self.visual_extractor)(weights=None)
...
class VisualExtractorDenseNet(nn.Module):
    def __init__(self, args):
        ...
        self.cached_file = "/cluster/work/medinfmk/ARGON/containers/models/densenet121-a639ec97.pth"
        if os.path.exists(self.cached_file):
            self.pretrained = False
        else:
            self.pretrained = True
...
class VisualExtractorDenseNet121(nn.Module):
    ...
    def forward(self, images):
        ...
        #print("#"*108)
        #print("In visual_extractor.py VisualExtractorDenseNet121()")
        #print("patch_feats, avg_feats", patch_feats.shape, avg_feats.shape)
        #print("#"*108)        
        return patch_feats, avg_feats
